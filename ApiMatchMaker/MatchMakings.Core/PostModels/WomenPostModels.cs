...
{
    public class WomenPostModels:BaseUserPostModels
    {
        public WomenPostModels(string FName, string LName, string Username, string Password, string Role) : base(FName, LName, Username, Password, Role)
        {
        }
        public WomenPostModels()
        {
