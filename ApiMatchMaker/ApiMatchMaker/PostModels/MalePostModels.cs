...
{
    public class MalePostModels:BaseUserPostModels
    {
        public MalePostModels(string FName, string LName, string Username, string Password, string Role) : base(FName, LName, Username, Password, Role)
        {
        }
        public MalePostModels()
        {
