    ...
    public class MaleRepository : IMaleRepository
    {
        ...
        public async Task<Male> UpdateMaleAsync(int id, Male updatedMale)
        {
            ...
            if (updatedMale != null)
            {
                ...
                existingMale.PhotoUrl = updatedMale.PhotoUrl;
                existingMale.TZFormUrl = updatedMale.TZFormUrl;
                existingMale.PhotoName = updatedMale.PhotoName;

                existingMale.TZFormName = updatedMale.TZFormName;
